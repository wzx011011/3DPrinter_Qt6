...
- [x] Phase 120: TriangleSelector Engine Port (WS2) (completed 2026-07-15)
- [x] Phase 121: Painted-Facet Overlay Render And Brush Interaction (WS2) (completed 2026-07-15)
- [x] Phase 122: Support And Seam Paint End-To-End (WS2) (completed 2026-07-15)
- [x] Phase 123: MMU Segmentation Paint End-To-End (WS2) (completed 2026-07-15)
- [x] Phase 124: Software-Sliceable Calibration Mode Completion (WS3) (completed 2026-07-15)
- [x] Phase 125: Calibration Range Input UI And Real K-Value Readback (WS3) (completed 2026-07-15)
- [x] Phase 126: Legacy Dead-Code Page Cleanup (WS4) (completed 2026-07-15)
- [x] Phase 127: i18n Translation Coverage And VALIDATION.md Backfill (WS4) (completed 2026-07-15)
- [x] Phase 128: v4.6 Verification And Cross-Workstream Regression (completed 2026-07-15)
