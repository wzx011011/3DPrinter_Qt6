# Requirements Archive: v4.0 Preview Page UI Restoration
...
- **TESTABILITY-FUTURE-01**: Add deterministic GUI fixture loading from argv/file paths for loaded-model/G-code visual evidence.
