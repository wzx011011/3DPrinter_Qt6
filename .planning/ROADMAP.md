...
**Plans:** 3 plans
Plans:
- [ ] 01-01-PLAN.md — QML UI 品牌字符串替换 (BRAND-01, BRAND-04)
- [ ] 01-02-PLAN.md — CMake 目标/选项重命名 + Crality3D 命名空间/CrealityGL 模块迁移 (BRAND-02, BRAND-03)
- [ ] 01-03-PLAN.md — C++ 源字符串 + 子模块移除 + 版本对齐 + 验证脚本 (BRAND-01, BRAND-02, BRAND-04, BRAND-05)
**Success Criteria:**
...
|-------|----------------|--------|-----------|
| 1. OWzx Brand Cleanup | 0/3 | Planned | — |
| 2. 9-Page Notebook + BBLTopbar | 0/0 | Pending | — |
| 3. Plater Shared Instance | 0/0 | Pending | — |
| 4. Sidebar Dockable Layout | 0/0 | Pending | — |
| 5. Prepare Sidebar 8 Sections | 0/0 | Pending | — |
| 6. GLCanvas Toolbar System | 0/0 | Pending | — |
| 7. Calibration Menu & Dialogs | 0/0 | Pending | — |

---
*Last updated: 2026-06-15 — Phase 1 plans created (3 plans, 3 waves)*
