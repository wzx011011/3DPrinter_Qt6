...
void ViewModelSmokeTests::sourceMappedProcessHierarchyMatchesTabPrint()
{
  ...
  const QList<ExpectedGroup> expected = {
      ...
      {QStringLiteral("Quality"), QStringLiteral("Ironing"), keys({"ironing_type", "ironing_pattern", "ironing_flow", "ironing_spacing", "ironing_inset", "ironing_angle", "ironing_angle_fixed"})},
      {QStringLiteral("Quality"), QStringLiteral("Z contouring"), keys({"zaa_enabled", "zaa_minimize_perimeter_height", "zaa_min_z", "zaa_dont_alternate_fill_direction", "ironing_expansion"})},
      {QStringLiteral("Quality"), QStringLiteral("Wall generator"), keys({"wall_generator", "wall_transition_angle", "wall_transition_filter_deviation", "wall_transition_length", "wall_distribution_count", "initial_layer_min_bead_width", "min_bead_width", "min_feature_size", "min_length_factor", "wall_maximum_resolution", "wall_maximum_deviation"})},
      ...
      {QStringLiteral("Quality"), QStringLiteral("Bridging"), keys({"bridge_flow", "internal_bridge_flow", "bridge_density", "internal_bridge_density", "thick_bridges", "thick_internal_bridges", "enable_extra_bridge_layer", "dont_filter_internal_bridges", "counterbore_hole_bridging"})},
      ...
      {QStringLiteral("Speed"), QStringLiteral("Overhang speed"), keys({"overhang_1_4_speed", "overhang_2_4_speed", "overhang_3_4_speed", "overhang_4_4_speed", "bridge_speed", "internal_bridge_speed", "enable_overhang_speed", "slowdown_for_curled_perimeters"})},
      ...
      {QStringLiteral("Speed"), QStringLiteral("Junction Deviation"), keys({"default_junction_deviation"})},
      {QStringLiteral("Speed"), QStringLiteral("Jerk(XY)"), keys({"default_jerk", "outer_wall_jerk", "inner_wall_jerk", "infill_jerk", "top_surface_jerk", "initial_layer_jerk", "initial_layer_travel_jerk", "travel_jerk"})},
      ...
      {QStringLiteral("Support"), QStringLiteral("Support"), keys({"enable_support", "support_type", "support_style", "support_threshold_angle", "support_threshold_overlap", "raft_first_layer_density", "raft_first_layer_expansion", "support_on_build_plate_only", "support_critical_regions_only", "support_remove_small_overhang", "enforce_support_layers"})},
      {QStringLiteral("Support"), QStringLiteral("Raft"), keys({"raft_layers", "raft_contact_distance"})},
      {QStringLiteral("Support"), QStringLiteral("Filament for Supports"), keys({"support_filament", "support_interface_filament", "support_interface_not_for_body"})},
      {QStringLiteral("Support"), QStringLiteral("Support ironing"), keys({"support_ironing", "support_ironing_pattern", "support_ironing_flow", "support_ironing_spacing"})},
      {QStringLiteral("Support"), QStringLiteral("Advanced"), keys({"support_top_z_distance", "support_bottom_z_distance", "tree_support_wall_count", "support_base_pattern", "support_base_pattern_spacing", "support_angle", "support_interface_top_layers", "support_interface_bottom_layers", "support_interface_pattern", "support_interface_spacing", "support_bottom_interface_spacing", "support_expansion", "support_interface_loop_pattern", "support_object_xy_distance", "support_object_first_layer_gap", "bridge_no_support", "max_bridge_length", "independent_support_layer_height"})},
      ...
      {QStringLiteral("Multimaterial"), QStringLiteral("Prime tower"), keys({"enable_prime_tower", "prime_tower_skip_points", "enable_tower_interface_features", "enable_tower_interface_cooldown_during_tower", "prime_tower_enable_framework", "prime_tower_width", "prime_volume", "prime_tower_brim_width", "prime_tower_infill_gap", "wipe_tower_rotation_angle", "wipe_tower_bridging", "wipe_tower_extra_spacing", "wipe_tower_extra_flow", "wipe_tower_max_purge_speed", "wipe_tower_wall_type", "wipe_tower_cone_angle", "wipe_tower_extra_rib_length", "wipe_tower_rib_width", "wipe_tower_fillet_wall", "wipe_tower_no_sparse_layers", "single_extruder_multi_material_priming"})},
      {QStringLiteral("Multimaterial"), QStringLiteral("Filament for Features"), keys({"outer_wall_filament_id", "inner_wall_filament_id", "sparse_infill_filament_id", "internal_solid_filament_id", "top_surface_filament_id", "bottom_surface_filament_id", "wipe_tower_filament"})},
