    ...
    : QWidget(parent)
{
  ...
  auto *projectIndex = new QLabel(QStringLiteral("1"), leftPanel);
  projectIndex->setObjectName("PreviewThumbIndex");
  projectIndex->setFixedSize(56, 56);
  projectIndex->setAlignment(Qt::AlignLeft | Qt::AlignTop);
  leftLayout->addWidget(projectIndex, 0, Qt::AlignLeft);
